 ...
 */
@Component
public class ProductConsumerB implements MessageListener {

    //@JmsListener(destination = Constans.QUEUE_NAME,containerFactory = Constans.LISTENER_CONTAINER_QUEUE_NAME)
    @Override
